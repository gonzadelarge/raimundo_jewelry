// Page copy. Spanish comes from texts/raimundo_texts.md (shortened).
...
export const copy = {
  es: {
    ...
    legal: {
      ...
      body: "Texto pendiente. Esta página existe para probar la navegación del pie.",
    },
    notFound: {
      title: "Esta pieza no está.",
      link: "Volver a la galería",
    },
  },
  en: {
    slogan: "Luxury jewelry with an underground spirit.",
    ...
    legal: {
      ...
      body: "Text pending. This page exists to test footer navigation.",
    },
    notFound: {
